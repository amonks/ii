...
// NutritionFacts mirrors the per-serving summary used in the Python toolkit.
...
// NewRecipeFromWeights mirrors Recipe.from_weights in Python.
...
// ComponentTotals aggregates per-nutrient totals similar to the Python helper.
