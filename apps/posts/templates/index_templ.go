...
func Index(posts *model.Posts) templ.Component {
	return templ.ComponentFunc(func(templ_7745c5c3_Ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(templ_7745c5c3_Ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			for _, post := range posts.List {
				if !post.IsDraft {
					...
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\"></a> <em>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
		...
		templ_7745c5c3_Err = page("posts").Render(templ.WithChildren(templ_7745c5c3_Ctx, templ_7745c5c3_Var2), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
