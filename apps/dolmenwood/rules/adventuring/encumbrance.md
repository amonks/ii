...
The carrying capacity of mounts and vehicles is listed in coins under [Horses and Vehicles](horses_and_vehicles).
...
The number of items that mounts and vehicles can carry is calculated by dividing their coin capacity by 100 (see [Horses and Vehicles](horses_and_vehicles)). The distinction between equipped and stowed items does not apply to horses and vehicles.
