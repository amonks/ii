...
**Easier circumstances:** Thieves make easier climbs without a roll (e.g. see [Climbing](hazards_and_challenges#climbing)).
...
A successful check allows a thief to disarm complex, clockwork-like trap mechanisms hidden in a lock, lid, door handle, or similar. Thieves’ tools are required for disarming mechanism traps (see [Adventuring Gear](adventuring_gear)).
...
A successful check allows a thief to open a lock without the key. Thieves’ tools are required for picking locks (see [Adventuring Gear](adventuring_gear)).
...
**Hiding:** A thief may make a Stealth Check to remain undetected when shadows are the only cover available. See Hiding and Ambushes under [Stealth](hazards_and_challenges#stealth).

**Sneaking:** If a Surprise Roll indicates that a thief’s party has been detected, the thief may make a Stealth Check to remain undetected. See [Surprise](encounters#surprise) and Sneaking under [Stealth](hazards_and_challenges#stealth).
