...
- **Prime Abilities:** Charisma and Dexterity
...
**Resisting:** Each subject must Save Versus Spell or be fascinated (see [Fascinated Subjects](bard#fascinated_subjects)).
...
**Duration:** The fascination lasts for as long as the bard’s performance continues. Afterwards, fascinated subjects may come under a stronger charm (see [When the Performance Ends](bard#when_the_performance_ends)).
