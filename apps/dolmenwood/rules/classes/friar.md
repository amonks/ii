...
In the hands of a friar, a single dose of a medicinal herb (for example those listed under [Common Fungi and Herbs](common_fungi_and_herbs)) is sufficient for 2 subjects.

## Holy magic

See [Holy Magic](holy_magic) for full details on holy magic, including praying for spells and the list of spells that friars can cast.

**Holy symbol:** A friar must carry a holy symbol (see [Adventuring Gear](adventuring_gear)).
