...
See [Holy Magic](holy_magic) for full details on holy magic, including praying for spells and the list of spells that clerics can cast.

**Holy symbol:** A cleric must carry a holy symbol (see [Adventuring Gear](adventuring_gear)).
