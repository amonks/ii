...
- **Charms of the Fey Court:** Contains the following Rank 1 spells: [Fairy Servant](fairy_servant), [Ingratiate](ingratiate), [Ventriloquism](ventriloquism).
- **Hogbrand’s Incandescence:** Contains the following Rank 1 spells: [Firelight](firelight), [Ignite / Extinguish](ignite_extinguish), [Shield of Force](shield_of_force).
- **Lord Oberon’s Seals:** Contains the following Rank 1 spells: [Decipher](decipher), [Glyph of Sealing](glyph_of_sealing), [Vapours of Dream](vapours_of_dream).
- **Oliphan’s Folio:** Contains the following Rank 1 spells: [Crystal Resonance](crystal_resonance), [Ioun Shard](ioun_shard), [Shield of Force](shield_of_force).
- **Smythe’s Illuminations:** Contains the following Rank 1 spells: [Decipher](decipher), [Ignite / Extinguish](ignite_extinguish), [Ioun Shard](ioun_shard).
- **The Treatise on Force and Dissolution:** Contains the following Rank 1 spells: [Crystal Resonance](crystal_resonance), [Floating Disc](floating_disc), [Vapours of Dream](vapours_of_dream).

## Arcane Magic

See [Arcane Magic](arcane_magic) for full details on arcane magic, including learning spells, spell memorisation, and the list of spells that magicians can learn.
