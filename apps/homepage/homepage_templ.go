...
func Homepage(data *PageData) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `apps/homepage/homepage.templ`, Line: 196, Col: 119}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `apps/homepage/homepage.templ`, Line: 196, Col: 150}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `apps/homepage/homepage.templ`, Line: 197, Col: 119}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `apps/homepage/homepage.templ`, Line: 197, Col: 150}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `apps/homepage/homepage.templ`, Line: 198, Col: 119}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `apps/homepage/homepage.templ`, Line: 198, Col: 150}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `apps/homepage/homepage.templ`, Line: 199, Col: 119}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `apps/homepage/homepage.templ`, Line: 199, Col: 150}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `apps/homepage/homepage.templ`, Line: 200, Col: 119}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `apps/homepage/homepage.templ`, Line: 200, Col: 150}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var16))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</a>.</dd></dl><p>I love exploring. I made a <a href=\"/map\">nice map</a> of places I have opinions about. It doesn't say what the opinions are, so you'll have to make your own. The map scrolls pretty slow; it used to be faster.</p><dl class=\"p-note prose-definition-list\"><dt>Sometimes I write about what I'm up to. Recently,</dt>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, post := range data.Posts.List {
			if !post.IsDraft {
				...
				var templ_7745c5c3_Var17 templ.SafeURL = templ.SafeURL(fmt.Sprintf("/posts/%s", post.Slug))
